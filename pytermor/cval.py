...
Color256(0x000000, 0,   "black",                register=True, index=True, color16_equiv=BLACK)
Color256(0x800000, 1,   "maroon",               register=True, index=True, color16_equiv=RED)
Color256(0x008000, 2,   "green",                register=True, index=True, color16_equiv=GREEN)
Color256(0x808000, 3,   "olive",                register=True, index=True, color16_equiv=YELLOW)
Color256(0x000080, 4,   "navy",                 register=True, index=True, color16_equiv=BLUE)
Color256(0x800080, 5,   "purple-5",             register=True, index=True, color16_equiv=MAGENTA)
Color256(0x008080, 6,   "teal",                 register=True, index=True, color16_equiv=CYAN)
Color256(0xc0c0c0, 7,   "silver",               register=True, index=True, color16_equiv=WHITE)
Color256(0x808080, 8,   "gray",                 register=True, index=True, color16_equiv=GRAY)
Color256(0xff0000, 9,   "red",                  register=True, index=True, color16_equiv=HI_RED)
Color256(0x00ff00, 10,  "lime",                 register=True, index=True, color16_equiv=HI_GREEN)
Color256(0xffff00, 11,  "yellow",               register=True, index=True, color16_equiv=HI_YELLOW)
Color256(0x0000ff, 12,  "blue",                 register=True, index=True, color16_equiv=HI_BLUE)
Color256(0xff00ff, 13,  "fuchsia",              register=True, index=True, color16_equiv=HI_MAGENTA)
Color256(0x00ffff, 14,  "aqua",                 register=True, index=True, color16_equiv=HI_CYAN)
Color256(0xffffff, 15,  "white",                register=True, index=True, color16_equiv=HI_WHITE)
GRAY_0              = Color256(0x000000, 16,  "gray-0",               register=True, index=True)
NAVY_BLUE           = Color256(0x00005f, 17,  "navy-blue",            register=True, index=True)
DARK_BLUE           = Color256(0x000087, 18,  "dark-blue",            register=True, index=True)
BLUE_3              = Color256(0x0000af, 19,  "blue-3",               register=True, index=True)
BLUE_2              = Color256(0x0000d7, 20,  "blue-2",               register=True, index=True)
BLUE_1              = Color256(0x0000ff, 21,  "blue-1",               register=True, index=True)
DARK_GREEN          = Color256(0x005f00, 22,  "dark-green",           register=True, index=True)
DEEP_SKY_BLUE_7     = Color256(0x005f5f, 23,  "deep-sky-blue-7",      register=True, index=True)
DEEP_SKY_BLUE_6     = Color256(0x005f87, 24,  "deep-sky-blue-6",      register=True, index=True)
DEEP_SKY_BLUE_5     = Color256(0x005faf, 25,  "deep-sky-blue-5",      register=True, index=True)
DODGER_BLUE_3       = Color256(0x005fd7, 26,  "dodger-blue-3",        register=True, index=True)
DODGER_BLUE_2       = Color256(0x005fff, 27,  "dodger-blue-2",        register=True, index=True)
GREEN_5             = Color256(0x008700, 28,  "green-5",              register=True, index=True)
SPRING_GREEN_4      = Color256(0x00875f, 29,  "spring-green-4",       register=True, index=True)
TURQUOISE_4         = Color256(0x008787, 30,  "turquoise-4",          register=True, index=True)
DEEP_SKY_BLUE_4     = Color256(0x0087af, 31,  "deep-sky-blue-4",      register=True, index=True)
DEEP_SKY_BLUE_3     = Color256(0x0087d7, 32,  "deep-sky-blue-3",      register=True, index=True)
DODGER_BLUE_1       = Color256(0x0087ff, 33,  "dodger-blue-1",        register=True, index=True)
GREEN_4             = Color256(0x00af00, 34,  "green-4",              register=True, index=True)
SPRING_GREEN_5      = Color256(0x00af5f, 35,  "spring-green-5",       register=True, index=True)
DARK_CYAN           = Color256(0x00af87, 36,  "dark-cyan",            register=True, index=True)
LIGHT_SEA_GREEN     = Color256(0x00afaf, 37,  "light-sea-green",      register=True, index=True)
DEEP_SKY_BLUE_2     = Color256(0x00afd7, 38,  "deep-sky-blue-2",      register=True, index=True)
DEEP_SKY_BLUE_1     = Color256(0x00afff, 39,  "deep-sky-blue-1",      register=True, index=True)
GREEN_3             = Color256(0x00d700, 40,  "green-3",              register=True, index=True)
SPRING_GREEN_3      = Color256(0x00d75f, 41,  "spring-green-3",       register=True, index=True)
SPRING_GREEN_6      = Color256(0x00d787, 42,  "spring-green-6",       register=True, index=True)
CYAN_3              = Color256(0x00d7af, 43,  "cyan-3",               register=True, index=True)
DARK_TURQUOISE      = Color256(0x00d7d7, 44,  "dark-turquoise",       register=True, index=True)
TURQUOISE_2         = Color256(0x00d7ff, 45,  "turquoise-2",          register=True, index=True)
GREEN_2             = Color256(0x00ff00, 46,  "green-2",              register=True, index=True)
SPRING_GREEN_2      = Color256(0x00ff5f, 47,  "spring-green-2",       register=True, index=True)
SPRING_GREEN_1      = Color256(0x00ff87, 48,  "spring-green-1",       register=True, index=True)
MEDIUM_SPRING_GREEN = Color256(0x00ffaf, 49,  "medium-spring-green",  register=True, index=True)
CYAN_2              = Color256(0x00ffd7, 50,  "cyan-2",               register=True, index=True)
CYAN_1              = Color256(0x00ffff, 51,  "cyan-1",               register=True, index=True)
DARK_RED_2          = Color256(0x5f0000, 52,  "dark-red-2",           register=True, index=True)
DEEP_PINK_8         = Color256(0x5f005f, 53,  "deep-pink-8",          register=True, index=True)
PURPLE_6            = Color256(0x5f0087, 54,  "purple-6",             register=True, index=True)
PURPLE_4            = Color256(0x5f00af, 55,  "purple-4",             register=True, index=True)
PURPLE_3            = Color256(0x5f00d7, 56,  "purple-3",             register=True, index=True)
BLUE_VIOLET         = Color256(0x5f00ff, 57,  "blue-violet",          register=True, index=True)
ORANGE_4            = Color256(0x5f5f00, 58,  "orange-4",             register=True, index=True)
GRAY_37             = Color256(0x5f5f5f, 59,  "gray-37",              register=True, index=True)
MEDIUM_PURPLE_7     = Color256(0x5f5f87, 60,  "medium-purple-7",      register=True, index=True)
SLATE_BLUE_3        = Color256(0x5f5faf, 61,  "slate-blue-3",         register=True, index=True)
SLATE_BLUE_2        = Color256(0x5f5fd7, 62,  "slate-blue-2",         register=True, index=True)
ROYAL_BLUE_1        = Color256(0x5f5fff, 63,  "royal-blue-1",         register=True, index=True)
CHARTREUSE_6        = Color256(0x5f8700, 64,  "chartreuse-6",         register=True, index=True)
DARK_SEA_GREEN_9    = Color256(0x5f875f, 65,  "dark-sea-green-9",     register=True, index=True)
PALE_TURQUOISE_4    = Color256(0x5f8787, 66,  "pale-turquoise-4",     register=True, index=True)
STEEL_BLUE          = Color256(0x5f87af, 67,  "steel-blue",           register=True, index=True)
STEEL_BLUE_3        = Color256(0x5f87d7, 68,  "steel-blue-3",         register=True, index=True)
CORNFLOWER_BLUE     = Color256(0x5f87ff, 69,  "cornflower-blue",      register=True, index=True)
CHARTREUSE_5        = Color256(0x5faf00, 70,  "chartreuse-5",         register=True, index=True)
DARK_SEA_GREEN_8    = Color256(0x5faf5f, 71,  "dark-sea-green-8",     register=True, index=True)
CADET_BLUE_2        = Color256(0x5faf87, 72,  "cadet-blue-2",         register=True, index=True)
CADET_BLUE          = Color256(0x5fafaf, 73,  "cadet-blue",           register=True, index=True)
SKY_BLUE_3          = Color256(0x5fafd7, 74,  "sky-blue-3",           register=True, index=True)
STEEL_BLUE_2        = Color256(0x5fafff, 75,  "steel-blue-2",         register=True, index=True)
CHARTREUSE_4        = Color256(0x5fd700, 76,  "chartreuse-4",         register=True, index=True)
PALE_GREEN_4        = Color256(0x5fd75f, 77,  "pale-green-4",         register=True, index=True)
SEA_GREEN_3         = Color256(0x5fd787, 78,  "sea-green-3",          register=True, index=True)
AQUAMARINE_3        = Color256(0x5fd7af, 79,  "aquamarine-3",         register=True, index=True)
MEDIUM_TURQUOISE    = Color256(0x5fd7d7, 80,  "medium-turquoise",     register=True, index=True)
STEEL_BLUE_1        = Color256(0x5fd7ff, 81,  "steel-blue-1",         register=True, index=True)
CHARTREUSE_2        = Color256(0x5fff00, 82,  "chartreuse-2",         register=True, index=True)
SEA_GREEN_4         = Color256(0x5fff5f, 83,  "sea-green-4",          register=True, index=True)
SEA_GREEN_2         = Color256(0x5fff87, 84,  "sea-green-2",          register=True, index=True)
SEA_GREEN_1         = Color256(0x5fffaf, 85,  "sea-green-1",          register=True, index=True)
AQUAMARINE_2        = Color256(0x5fffd7, 86,  "aquamarine-2",         register=True, index=True)
DARK_SLATE_GRAY_2   = Color256(0x5fffff, 87,  "dark-slate-gray-2",    register=True, index=True)
DARK_RED            = Color256(0x870000, 88,  "dark-red",             register=True, index=True)
DEEP_PINK_7         = Color256(0x87005f, 89,  "deep-pink-7",          register=True, index=True)
DARK_MAGENTA_2      = Color256(0x870087, 90,  "dark-magenta-2",       register=True, index=True)
DARK_MAGENTA        = Color256(0x8700af, 91,  "dark-magenta",         register=True, index=True)
DARK_VIOLET_2       = Color256(0x8700d7, 92,  "dark-violet-2",        register=True, index=True)
PURPLE_2            = Color256(0x8700ff, 93,  "purple-2",             register=True, index=True)
ORANGE_3            = Color256(0x875f00, 94,  "orange-3",             register=True, index=True)
LIGHT_PINK_3        = Color256(0x875f5f, 95,  "light-pink-3",         register=True, index=True)
PLUM_4              = Color256(0x875f87, 96,  "plum-4",               register=True, index=True)
MEDIUM_PURPLE_6     = Color256(0x875faf, 97,  "medium-purple-6",      register=True, index=True)
MEDIUM_PURPLE_5     = Color256(0x875fd7, 98,  "medium-purple-5",      register=True, index=True)
SLATE_BLUE_1        = Color256(0x875fff, 99,  "slate-blue-1",         register=True, index=True)
YELLOW_6            = Color256(0x878700, 100, "yellow-6",             register=True, index=True)
WHEAT_4             = Color256(0x87875f, 101, "wheat-4",              register=True, index=True)
GRAY_53             = Color256(0x878787, 102, "gray-53",              register=True, index=True)
LIGHT_SLATE_GRAY    = Color256(0x8787af, 103, "light-slate-gray",     register=True, index=True)
MEDIUM_PURPLE_4     = Color256(0x8787d7, 104, "medium-purple-4",      register=True, index=True)
LIGHT_SLATE_BLUE    = Color256(0x8787ff, 105, "light-slate-blue",     register=True, index=True)
YELLOW_4            = Color256(0x87af00, 106, "yellow-4",             register=True, index=True)
DARK_OLIVE_GREEN_6  = Color256(0x87af5f, 107, "dark-olive-green-6",   register=True, index=True)
DARK_SEA_GREEN_7    = Color256(0x87af87, 108, "dark-sea-green-7",     register=True, index=True)
LIGHT_SKY_BLUE_3    = Color256(0x87afaf, 109, "light-sky-blue-3",     register=True, index=True)
LIGHT_SKY_BLUE_2    = Color256(0x87afd7, 110, "light-sky-blue-2",     register=True, index=True)
SKY_BLUE_2          = Color256(0x87afff, 111, "sky-blue-2",           register=True, index=True)
CHARTREUSE_3        = Color256(0x87d700, 112, "chartreuse-3",         register=True, index=True)
DARK_OLIVE_GREEN_4  = Color256(0x87d75f, 113, "dark-olive-green-4",   register=True, index=True)
PALE_GREEN_3        = Color256(0x87d787, 114, "pale-green-3",         register=True, index=True)
DARK_SEA_GREEN_5    = Color256(0x87d7af, 115, "dark-sea-green-5",     register=True, index=True)
DARK_SLATE_GRAY_3   = Color256(0x87d7d7, 116, "dark-slate-gray-3",    register=True, index=True)
SKY_BLUE_1          = Color256(0x87d7ff, 117, "sky-blue-1",           register=True, index=True)
CHARTREUSE_1        = Color256(0x87ff00, 118, "chartreuse-1",         register=True, index=True)
LIGHT_GREEN_2       = Color256(0x87ff5f, 119, "light-green-2",        register=True, index=True)
LIGHT_GREEN         = Color256(0x87ff87, 120, "light-green",          register=True, index=True)
PALE_GREEN_1        = Color256(0x87ffaf, 121, "pale-green-1",         register=True, index=True)
AQUAMARINE_1        = Color256(0x87ffd7, 122, "aquamarine-1",         register=True, index=True)
DARK_SLATE_GRAY_1   = Color256(0x87ffff, 123, "dark-slate-gray-1",    register=True, index=True)
RED_4               = Color256(0xaf0000, 124, "red-4",                register=True, index=True)
DEEP_PINK_6         = Color256(0xaf005f, 125, "deep-pink-6",          register=True, index=True)
MEDIUM_VIOLET_RED   = Color256(0xaf0087, 126, "medium-violet-red",    register=True, index=True)
MAGENTA_6           = Color256(0xaf00af, 127, "magenta-6",            register=True, index=True)
DARK_VIOLET         = Color256(0xaf00d7, 128, "dark-violet",          register=True, index=True)
PURPLE              = Color256(0xaf00ff, 129, "purple",               register=True, index=True)
DARK_ORANGE_3       = Color256(0xaf5f00, 130, "dark-orange-3",        register=True, index=True)
INDIAN_RED_4        = Color256(0xaf5f5f, 131, "indian-red-4",         register=True, index=True)
HOT_PINK_5          = Color256(0xaf5f87, 132, "hot-pink-5",           register=True, index=True)
MEDIUM_ORCHID_4     = Color256(0xaf5faf, 133, "medium-orchid-4",      register=True, index=True)
MEDIUM_ORCHID_3     = Color256(0xaf5fd7, 134, "medium-orchid-3",      register=True, index=True)
MEDIUM_PURPLE_2     = Color256(0xaf5fff, 135, "medium-purple-2",      register=True, index=True)
DARK_GOLDENROD      = Color256(0xaf8700, 136, "dark-goldenrod",       register=True, index=True)
LIGHT_SALMON_3      = Color256(0xaf875f, 137, "light-salmon-3",       register=True, index=True)
ROSY_BROWN          = Color256(0xaf8787, 138, "rosy-brown",           register=True, index=True)
GRAY_63             = Color256(0xaf87af, 139, "gray-63",              register=True, index=True)
MEDIUM_PURPLE_3     = Color256(0xaf87d7, 140, "medium-purple-3",      register=True, index=True)
MEDIUM_PURPLE_1     = Color256(0xaf87ff, 141, "medium-purple-1",      register=True, index=True)
GOLD_3              = Color256(0xafaf00, 142, "gold-3",               register=True, index=True)
DARK_KHAKI          = Color256(0xafaf5f, 143, "dark-khaki",           register=True, index=True)
NAVAJO_WHITE_3      = Color256(0xafaf87, 144, "navajo-white-3",       register=True, index=True)
GRAY_69             = Color256(0xafafaf, 145, "gray-69",              register=True, index=True)
LIGHT_STEEL_BLUE_3  = Color256(0xafafd7, 146, "light-steel-blue-3",   register=True, index=True)
LIGHT_STEEL_BLUE_2  = Color256(0xafafff, 147, "light-steel-blue-2",   register=True, index=True)
YELLOW_5            = Color256(0xafd700, 148, "yellow-5",             register=True, index=True)
DARK_OLIVE_GREEN_5  = Color256(0xafd75f, 149, "dark-olive-green-5",   register=True, index=True)
DARK_SEA_GREEN_6    = Color256(0xafd787, 150, "dark-sea-green-6",     register=True, index=True)
DARK_SEA_GREEN_4    = Color256(0xafd7af, 151, "dark-sea-green-4",     register=True, index=True)
LIGHT_CYAN_3        = Color256(0xafd7d7, 152, "light-cyan-3",         register=True, index=True)
LIGHT_SKY_BLUE_1    = Color256(0xafd7ff, 153, "light-sky-blue-1",     register=True, index=True)
GREEN_YELLOW        = Color256(0xafff00, 154, "green-yellow",         register=True, index=True)
DARK_OLIVE_GREEN_3  = Color256(0xafff5f, 155, "dark-olive-green-3",   register=True, index=True)
PALE_GREEN_2        = Color256(0xafff87, 156, "pale-green-2",         register=True, index=True)
DARK_SEA_GREEN_3    = Color256(0xafffaf, 157, "dark-sea-green-3",     register=True, index=True)
DARK_SEA_GREEN_1    = Color256(0xafffd7, 158, "dark-sea-green-1",     register=True, index=True)
PALE_TURQUOISE_1    = Color256(0xafffff, 159, "pale-turquoise-1",     register=True, index=True)
RED_3               = Color256(0xd70000, 160, "red-3",                register=True, index=True)
DEEP_PINK_5         = Color256(0xd7005f, 161, "deep-pink-5",          register=True, index=True)
DEEP_PINK_3         = Color256(0xd70087, 162, "deep-pink-3",          register=True, index=True)
MAGENTA_3           = Color256(0xd700af, 163, "magenta-3",            register=True, index=True)
MAGENTA_5           = Color256(0xd700d7, 164, "magenta-5",            register=True, index=True)
MAGENTA_4           = Color256(0xd700ff, 165, "magenta-4",            register=True, index=True)
DARK_ORANGE_2       = Color256(0xd75f00, 166, "dark-orange-2",        register=True, index=True)
INDIAN_RED_3        = Color256(0xd75f5f, 167, "indian-red-3",         register=True, index=True)
HOT_PINK_4          = Color256(0xd75f87, 168, "hot-pink-4",           register=True, index=True)
HOT_PINK_3          = Color256(0xd75faf, 169, "hot-pink-3",           register=True, index=True)
ORCHID_3            = Color256(0xd75fd7, 170, "orchid-3",             register=True, index=True)
MEDIUM_ORCHID_2     = Color256(0xd75fff, 171, "medium-orchid-2",      register=True, index=True)
ORANGE_2            = Color256(0xd78700, 172, "orange-2",             register=True, index=True)
LIGHT_SALMON_2      = Color256(0xd7875f, 173, "light-salmon-2",       register=True, index=True)
LIGHT_PINK_2        = Color256(0xd78787, 174, "light-pink-2",         register=True, index=True)
PINK_3              = Color256(0xd787af, 175, "pink-3",               register=True, index=True)
PLUM_3              = Color256(0xd787d7, 176, "plum-3",               register=True, index=True)
VIOLET              = Color256(0xd787ff, 177, "violet",               register=True, index=True)
GOLD_2              = Color256(0xd7af00, 178, "gold-2",               register=True, index=True)
LIGHT_GOLDENROD_5   = Color256(0xd7af5f, 179, "light-goldenrod-5",    register=True, index=True)
TAN                 = Color256(0xd7af87, 180, "tan",                  register=True, index=True)
MISTY_ROSE_3        = Color256(0xd7afaf, 181, "misty-rose-3",         register=True, index=True)
THISTLE_3           = Color256(0xd7afd7, 182, "thistle-3",            register=True, index=True)
PLUM_2              = Color256(0xd7afff, 183, "plum-2",               register=True, index=True)
YELLOW_3            = Color256(0xd7d700, 184, "yellow-3",             register=True, index=True)
KHAKI_3             = Color256(0xd7d75f, 185, "khaki-3",              register=True, index=True)
LIGHT_GOLDENROD_3   = Color256(0xd7d787, 186, "light-goldenrod-3",    register=True, index=True)
LIGHT_YELLOW_3      = Color256(0xd7d7af, 187, "light-yellow-3",       register=True, index=True)
GRAY_84             = Color256(0xd7d7d7, 188, "gray-84",              register=True, index=True)
LIGHT_STEEL_BLUE_1  = Color256(0xd7d7ff, 189, "light-steel-blue-1",   register=True, index=True)
YELLOW_2            = Color256(0xd7ff00, 190, "yellow-2",             register=True, index=True)
DARK_OLIVE_GREEN_2  = Color256(0xd7ff5f, 191, "dark-olive-green-2",   register=True, index=True)
DARK_OLIVE_GREEN_1  = Color256(0xd7ff87, 192, "dark-olive-green-1",   register=True, index=True)
DARK_SEA_GREEN_2    = Color256(0xd7ffaf, 193, "dark-sea-green-2",     register=True, index=True)
HONEYDEW_2          = Color256(0xd7ffd7, 194, "honeydew-2",           register=True, index=True)
LIGHT_CYAN_1        = Color256(0xd7ffff, 195, "light-cyan-1",         register=True, index=True)
RED_1               = Color256(0xff0000, 196, "red-1",                register=True, index=True)
DEEP_PINK_4         = Color256(0xff005f, 197, "deep-pink-4",          register=True, index=True)
DEEP_PINK_2         = Color256(0xff0087, 198, "deep-pink-2",          register=True, index=True)
DEEP_PINK_1         = Color256(0xff00af, 199, "deep-pink-1",          register=True, index=True)
MAGENTA_2           = Color256(0xff00d7, 200, "magenta-2",            register=True, index=True)
MAGENTA_1           = Color256(0xff00ff, 201, "magenta-1",            register=True, index=True)
ORANGE_RED_1        = Color256(0xff5f00, 202, "orange-red-1",         register=True, index=True)
INDIAN_RED_1        = Color256(0xff5f5f, 203, "indian-red-1",         register=True, index=True)
INDIAN_RED_2        = Color256(0xff5f87, 204, "indian-red-2",         register=True, index=True)
HOT_PINK_2          = Color256(0xff5faf, 205, "hot-pink-2",           register=True, index=True)
HOT_PINK            = Color256(0xff5fd7, 206, "hot-pink",             register=True, index=True)
MEDIUM_ORCHID_1     = Color256(0xff5fff, 207, "medium-orchid-1",      register=True, index=True)
DARK_ORANGE         = Color256(0xff8700, 208, "dark-orange",          register=True, index=True)
SALMON_1            = Color256(0xff875f, 209, "salmon-1",             register=True, index=True)
LIGHT_CORAL         = Color256(0xff8787, 210, "light-coral",          register=True, index=True)
PALE_VIOLET_RED_1   = Color256(0xff87af, 211, "pale-violet-red-1",    register=True, index=True)
ORCHID_2            = Color256(0xff87d7, 212, "orchid-2",             register=True, index=True)
ORCHID_1            = Color256(0xff87ff, 213, "orchid-1",             register=True, index=True)
ORANGE_1            = Color256(0xffaf00, 214, "orange-1",             register=True, index=True)
SANDY_BROWN         = Color256(0xffaf5f, 215, "sandy-brown",          register=True, index=True)
LIGHT_SALMON_1      = Color256(0xffaf87, 216, "light-salmon-1",       register=True, index=True)
LIGHT_PINK_1        = Color256(0xffafaf, 217, "light-pink-1",         register=True, index=True)
PINK_1              = Color256(0xffafd7, 218, "pink-1",               register=True, index=True)
PLUM_1              = Color256(0xffafff, 219, "plum-1",               register=True, index=True)
GOLD_1              = Color256(0xffd700, 220, "gold-1",               register=True, index=True)
LIGHT_GOLDENROD_4   = Color256(0xffd75f, 221, "light-goldenrod-4",    register=True, index=True)
LIGHT_GOLDENROD_2   = Color256(0xffd787, 222, "light-goldenrod-2",    register=True, index=True)
NAVAJO_WHITE_1      = Color256(0xffd7af, 223, "navajo-white-1",       register=True, index=True)
MISTY_ROSE_1        = Color256(0xffd7d7, 224, "misty-rose-1",         register=True, index=True)
THISTLE_1           = Color256(0xffd7ff, 225, "thistle-1",            register=True, index=True)
YELLOW_1            = Color256(0xffff00, 226, "yellow-1",             register=True, index=True)
LIGHT_GOLDENROD_1   = Color256(0xffff5f, 227, "light-goldenrod-1",    register=True, index=True)
KHAKI_1             = Color256(0xffff87, 228, "khaki-1",              register=True, index=True)
WHEAT_1             = Color256(0xffffaf, 229, "wheat-1",              register=True, index=True)
CORNSILK_1          = Color256(0xffffd7, 230, "cornsilk-1",           register=True, index=True)
GRAY_100            = Color256(0xffffff, 231, "gray-100",             register=True, index=True)
GRAY_3              = Color256(0x080808, 232, "gray-3",               register=True, index=True)
GRAY_7              = Color256(0x121212, 233, "gray-7",               register=True, index=True)
GRAY_11             = Color256(0x1c1c1c, 234, "gray-11",              register=True, index=True)
GRAY_15             = Color256(0x262626, 235, "gray-15",              register=True, index=True)
GRAY_19             = Color256(0x303030, 236, "gray-19",              register=True, index=True)
GRAY_23             = Color256(0x3a3a3a, 237, "gray-23",              register=True, index=True)
GRAY_27             = Color256(0x444444, 238, "gray-27",              register=True, index=True)
GRAY_30             = Color256(0x4e4e4e, 239, "gray-30",              register=True, index=True)
GRAY_35             = Color256(0x585858, 240, "gray-35",              register=True, index=True)
GRAY_39             = Color256(0x626262, 241, "gray-39",              register=True, index=True)
GRAY_42             = Color256(0x6c6c6c, 242, "gray-42",              register=True, index=True)
GRAY_46             = Color256(0x767676, 243, "gray-46",              register=True, index=True)
GRAY_50             = Color256(0x808080, 244, "gray-50",              register=True, index=True)
GRAY_54             = Color256(0x8a8a8a, 245, "gray-54",              register=True, index=True)
GRAY_58             = Color256(0x949494, 246, "gray-58",              register=True, index=True)
GRAY_62             = Color256(0x9e9e9e, 247, "gray-62",              register=True, index=True)
GRAY_66             = Color256(0xa8a8a8, 248, "gray-66",              register=True, index=True)
GRAY_70             = Color256(0xb2b2b2, 249, "gray-70",              register=True, index=True)
GRAY_74             = Color256(0xbcbcbc, 250, "gray-74",              register=True, index=True)
GRAY_78             = Color256(0xc6c6c6, 251, "gray-78",              register=True, index=True)
GRAY_82             = Color256(0xd0d0d0, 252, "gray-82",              register=True, index=True)
GRAY_85             = Color256(0xdadada, 253, "gray-85",              register=True, index=True)
GRAY_89             = Color256(0xe4e4e4, 254, "gray-89",              register=True, index=True)
GRAY_93             = Color256(0xeeeeee, 255, "gray-93",              register=True, index=True)
