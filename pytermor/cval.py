...
class CVAL:
    ...
    ColorRGB(0xff8f73, "alexandria",                            register=True, index=True)
    ...
    ColorRGB(0xb3f5ff, "arctic-chill",                          register=True, index=True)
    ...
    ColorRGB(0x4c9aff, "arvo-breeze",                           register=True, index=True)
    ...
    ColorRGB(0x212328, "black-kalm",                            register=True, index=True)
    ...
    ColorRGB(0xa5adba, "blanche",                               register=True, index=True)
    ...
    ColorRGB(0x6b778c, "bling-bling",                           register=True, index=True)
    ...
    ColorRGB(0x5f819d, "blue-kalm",                             register=True, index=True)
    ...
    ColorRGB(0xffbdad, "bondi-sunburn",                         register=True, index=True)
    ...
    ColorRGB(0xff991f, "cheezy-blasters",                       register=True, index=True)
    ...
    ColorRGB(0x0747a6, "chore-coat",                            register=True, index=True)
    ...
    ColorRGB(0x505f79, "concrete-jungle",                       register=True, index=True)
    ...
    ColorRGB(0x2684ff, "coogee",                                register=True, index=True)
    ...
    ColorRGB(0xffe380, "cowbell",                               register=True, index=True)
    ...
    ColorRGB(0x00b7eb, "cyan",                                  register=True, index=True)
    ...
    ColorRGB(0x5e8d87, "cyan-kalm",                             register=True, index=True)
    ...
    ColorRGB(0x6554c0, "da-juice",                              register=True, index=True, aliases=['jira-violet'])
    ColorRGB(0xffff31, "daffodil",                              register=True, index=True)
    ColorRGB(0xf0e130, "dandelion",                             register=True, index=True, variation_map={
             0xfddb6d:   "crayola" })
    ColorRGB(0xfff0b3, "dandelion-whisper",                     register=True, index=True)
    ...
    ColorRGB(0xff8b00, "debrito",                               register=True, index=True)
    ...
    ColorRGB(0xbf2600, "dragons-blood",                         register=True, index=True)
    ...
    ColorRGB(0x36b37e, "fine-pine",                             register=True, index=True, aliases=['jira-green'])
    ...
    ColorRGB(0xffffff, "full-white",                            register=True, index=True, aliases=['true-white', 'pure-white', 'doctor'])
    ...
    ColorRGB(0xffab00, "golden-state",                          register=True, index=True, aliases=['jira-yellow'])
    ...
    ColorRGB(0xf4f5f7, "grams-hair",                            register=True, index=True)
    ColorRGB(0xe6fcff, "grams-sofa",                            register=True, index=True)
    ...
    ColorRGB(0x606670, "gray-kalm",                             register=True, index=True)
    ...
    ColorRGB(0x769440, "green-kalm",                            register=True, index=True)
    ...
    ColorRGB(0x824b35, "green-tea",                             register=True, index=True, variation_map={
             0x57d9a3:   "atlassian" })
    ...
    ColorRGB(0x79e2f2, "hairy-fairy",                           register=True, index=True)
    ...
    ColorRGB(0x998dd9, "herky-jerky",                           register=True, index=True)
    ColorRGB(0x81a2be, "hi-blue-kalm",                          register=True, index=True)
    ColorRGB(0x8abeb7, "hi-cyan-kalm",                          register=True, index=True)
    ColorRGB(0xa4bd68, "hi-green-kalm",                         register=True, index=True)
    ColorRGB(0xb294bb, "hi-magenta-kalm",                       register=True, index=True)
    ColorRGB(0xcc6666, "hi-red-kalm",                           register=True, index=True)
    ColorRGB(0xdbdbdb, "hi-white-kalm",                         register=True, index=True)
    ColorRGB(0xf0c674, "hi-yellow-kalm",                        register=True, index=True)
    ...
    ColorRGB(0xcf0a2c, "huawei-red",                            register=True, index=True, variation_map={
             0xed1c24:   "1987-2018" })
    ColorRGB(0x7a869a, "humboldt-fog",                          register=True, index=True)
    ColorRGB(0xf58f84, "ibis-wing",                             register=True, index=True)
    ColorRGB(0xe7c899, "icathian-yellow",                       register=True, index=True)
    ...
    ColorRGB(0xfffae6, "james-blonde",                          register=True, index=True)
    ...
    ColorRGB(0xdfe1e6, "jolly-fun-time",                        register=True, index=True)
    ...
    ColorRGB(0xc1c7d0, "karl",                                  register=True, index=True)
    ColorRGB(0x006644, "keen-green",                            register=True, index=True)
    ...
    ColorRGB(0xeae6ff, "lavender-secret",                       register=True, index=True)
    ...
    ColorRGB(0x85678f, "magenta-kalm",                          register=True, index=True)
    ...
    ColorRGB(0x42526e, "mc-fanning",                            register=True, index=True)
    ...
    ColorRGB(0x8993a4, "meredith",                              register=True, index=True)
    ColorRGB(0x00c7e6, "mermaid-net",                           register=True, index=True)
    ...
    ColorRGB(0xabf5d1, "mintie",                                register=True, index=True)
    ...
    ColorRGB(0x7280e2, "moonlightd",                            register=True, index=True)
    ...
    ColorRGB(0xebecf0, "northeast-snow",                        register=True, index=True)
    ...
    ColorRGB(0x0052cc, "pacific-bridge",                        register=True, index=True, aliases=['jira-blue'])
    ...
    ColorRGB(0x8777d9, "pastelli",                              register=True, index=True)
    ...
    ColorRGB(0x344563, "pet-rock",                              register=True, index=True)
    ColorRGB(0x8ba8b7, "pewter-blue",                           register=True, index=True)
    ColorRGB(0xc0b6f2, "phantom-mist",                          register=True, index=True)
    ...
    ColorRGB(0xdeebff, "pixie-dust",                            register=True, index=True)
    ...
    ColorRGB(0xff5630, "poppy-surprise",                        register=True, index=True, aliases=['jira-red'])
    ...
    ColorRGB(0xde350b, "red-dirt",                              register=True, index=True)
    ColorRGB(0xf07f5e, "red-incense",                           register=True, index=True)
    ColorRGB(0xa54242, "red-kalm",                              register=True, index=True)
    ...
    ColorRGB(0xffebe6, "rosie",                                 register=True, index=True)
    ...
    ColorRGB(0xff7452, "salmon-sashimi",                        register=True, index=True)
    ...
    ColorRGB(0xb3d4ff, "schwag",                                register=True, index=True)
    ...
    ColorRGB(0xb3bac5, "sentinel",                              register=True, index=True)
    ...
    ColorRGB(0x008da6, "shabby-chic",                           register=True, index=True)
    ...
    ColorRGB(0x253858, "snorlax",                               register=True, index=True)
    ColorRGB(0xfffafa, "snow",                                  register=True, index=True)
    ColorRGB(0x5243aa, "snozzberry",                            register=True, index=True)
    ColorRGB(0xcec8ef, "soap",                                  register=True, index=True)
    ColorRGB(0x0065ff, "sodium-explosion",                      register=True, index=True)
    ...
    ColorRGB(0x97a0af, "spooky-ghost",                          register=True, index=True)
    ...
    ColorRGB(0x172b4d, "squid-ink",                             register=True, index=True, aliases=['jira-black'])
    ...
    ColorRGB(0x00b8d9, "tamarama",                              register=True, index=True, aliases=['jira-cyan'])
    ...
    ColorRGB(0xe3fcef, "the-smell",                             register=True, index=True)
    ...
    ColorRGB(0xfafbfc, "wash-me",                               register=True, index=True)
    ...
    ColorRGB(0x969896, "white-kalm",                            register=True, index=True)
    ...
    ColorRGB(0x9acd32, "yellow-green",                          register=True, index=True, variation_map={
             ...
             0xc5e384:   "crayola" })
    ColorRGB(0xde935f, "yellow-kalm",                           register=True, index=True)
