...
class TestPrefixedUnit:
    ...
    def test_format_si_metric_no_unit(self, expected: str, value: float):
    ...
    def test_format_si_metric_lower_with_unit(self, expected: str, value: float):
        assert format_si_metric(value, unit="m") == expected
    ...
    def test_format_si_unit_upper_with_unit(self, expected: str, value: float):
        assert format_si_metric(value, unit="V") == expected

    @pytest.mark.parametrize(
        "value,legacy_rounding,expected", [(0.2, False, "200m"), (0.2, True, "0.20")]
    )
...
class TextPrefixedUnitResultLength:
